 ...
 <!-- Breadcromb Area Start -->
    ...
    <section class="jobguru-top-job-area browse-page section_70">
               ...
               <div class="single-job-sidebar sidebar-location">
                  ...
                  foreach($terms as $term) {
                     ...
                     <div class="form-group form-radio">
                        <input id="accounting-finance" value="accounting-finance" name="jobs_type_cat" type="radio">
                        <label for="accounting-finance" class="inline control-label">
         ...
         if($query->have_posts()):
			...
			<p class="company-state"><a href="#"><i class="fa fa-map-marker"></i><?php echo get_field('field_6278e13325db3'); ?></a></p>
			<p class="open-icon"><i class="fa fa-briefcase"></i><?php echo get_field('field_6278e34dc145a'); ?></p>
			<p class="varify"><i class="fa fa-user"></i><?php echo get_field('field_6278e76a8c437'); ?></p>
			<p class="calendar"><i class="fa fa-calendar"></i>Posted Date:<?php echo get_field('field_6278e7278c435'); ?></p>
			<p class="calendar"><i class="fa fa-calendar"></i>Expiry Date: <?php echo get_field('field_6278e7528c436'); ?></p>
                              </div>
